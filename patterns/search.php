...
<main class="wp-block-group alignfull"><!-- wp:query-title {"type":"search","align":"wide","style":{"typography":{"lineHeight":"1"},"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|10"}}}} /-->
...
<!-- wp:paragraph -->
<p><?php echo __('No posts were found.', 'twentytwentyfour');?></p>
<!-- /wp:paragraph -->
<!-- /wp:query-no-results -->
